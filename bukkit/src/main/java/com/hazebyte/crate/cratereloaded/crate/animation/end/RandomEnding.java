...
public class RandomEnding extends Ending {
    public RandomEnding(Crate crate, PluginSettingComponent settings) {
        super(crate, settings);
        this.length = 60;
    }

    public RandomEnding(Crate crate, int length, PluginSettingComponent settings) {
    ...
    private class RandomEndingTask extends AnimationTask {
        ...
        private void phaseOne(Inventory inventory) {
